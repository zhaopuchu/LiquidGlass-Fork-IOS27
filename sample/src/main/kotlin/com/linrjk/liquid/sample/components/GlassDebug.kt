...
@Composable
fun rememberGlassDebugState(): GlassDebugState {
    return remember { GlassDebugState() }
}
            ...
            Column(
                ...
                Row(
                    ...
                    Column(
                        ...
                        GlassDebugSlider("Corner radius", { state.cornerRadiusFrac }, 0f..1f, 0.001f, sheetBackdrop) {
...
private fun GlassDebugSlider(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8f.dp)) {
        BasicText("$label  ${"%.2f".format(current)}")
        LiquidSlider(
            value = value,
